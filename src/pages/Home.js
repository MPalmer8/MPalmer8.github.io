    ...
    <div className="aboutme">
      ...
      >
        <div className="aboutmebox">
          <h2>About me</h2>
          <p>As you could probably tell from the details above, my name is Matthew. I am about to go into my 3rd year of university studies embarking on a BSc Computer Science course at my chosen university of King's College London, or KCL for short. I have a keen passion for technology and software engineering which has led me to create projects and gain various experiences within the sector.</p>
